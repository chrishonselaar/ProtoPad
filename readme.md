A simple tool for LIVE interactive development on iOS and Android.
...
Contributions
Any valuable contributions to this project are WELCOMED!! A lot of work is necessary on the interface, cleaning up the code, planned features (see below), a Mac OS X version, etc. I would be very grateful for any and all help here! I am explicitly giving this project ot the community, so that it can get better.
